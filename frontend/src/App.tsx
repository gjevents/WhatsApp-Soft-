...
function MediaLibraryPage() {
  ...
  const getFileUrl = (file: MediaFile) => `/media/${file.storage_path?.replaceAll('\\', '/').split('/').map(encodeURIComponent).join('/')}`;
  const getDownloadUrl = (file: MediaFile) => `${API_URL}/media/${file.id}/download`;
